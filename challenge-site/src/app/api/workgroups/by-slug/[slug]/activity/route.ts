  ...
  return NextResponse.json(
    {
      ...
      items,
      filter_definition:
        'Comments & patches = Canopi discuss (comments + PATCH/INSERT), Gov Hub draft proposals/patches, workgroup chat, member chapter edits, Astra revocations. All adds downloads. Excludes joins, leaves, invites, and generic draft lifecycle events.',
    },
    {
      headers: {
