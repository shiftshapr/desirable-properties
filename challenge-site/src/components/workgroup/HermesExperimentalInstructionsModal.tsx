    ...
    >
      ...
      >
        ...
        <div id={descId} className="mt-3 space-y-3 text-sm leading-relaxed text-slate-300">
          <p>
            Deepi in workgroup chat is experimental. Replies stay private until you choose to share
            or adopt them as your own message.
          </p>

          <section>
            <p className="font-medium text-slate-200">Draft my message vs Ask Deepi</p>
            <ul className="mt-2 list-disc space-y-2 pl-5 marker:text-cyan-500">
              ...
              <li>
                <span className="font-medium text-slate-200">Ask Deepi</span> – Deepi replies in
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-2 pl-5 marker:text-violet-500">
              <li>
                Open the <span className="font-medium text-slate-200">Deepi</span> panel for raised
                hands and Ask Deepi replies.
              </li>
              <li>
                <span className="font-medium text-slate-200">Share to thread</span> posts with clear
                Deepi attribution (✋ Deepi).
              </li>
              <li>
          ...
          <section>
            ...
            <p className="mt-2 text-slate-400">
              When ambient mode is on, Deepi may raise a hand (✋) on thread messages with a short
              teaser. Open the hand for a full private reply. Hands never post automatically.
            </p>
          </section>

          <section>
            <p className="font-medium text-slate-200">What posts as you vs as Deepi</p>
            <ul className="mt-2 list-disc space-y-2 pl-5 marker:text-violet-500">
              <li>
              ...
              <li>
                <span className="font-medium text-slate-200">Deepi</span> – only when you share a
                Deepi note to the thread (labeled ✋ Deepi).
              </li>
            </ul>
          </section>

          <p className="text-slate-400">
            Deepi may also raise its hand after messages when ambient mode is enabled for this
