/** SSOT mirror of /desirable-properties/docs/dp-welcome-messages.md (Message A + lead block). */

export const DP_WELCOME_SUBJECT_MEMBER = 'Welcome to the Desirable Properties Challenge';
export const DP_WELCOME_SUBJECT_LEAD =
  'Welcome to the Desirable Properties Challenge — Workgroup lead';
