...
The mechanisms below define the minimum structural conditions for civic memory. The domain sections that follow expand them into the civic memory layer, its operational conditions, its governance requirements, and its interface expression.

### 5.1 Memory objects with durable reference
...
### 5.6 Attenuation and sealing policies
...
### 5.8 Uncertainty and dispute signaling
...
## 6. Civic Memory Layer: Continuity, Transformation, and Retrieval
...
### 6.2 Transformation accountability
...
### 6.6 Humane forgetting and attenuation
...
## 7. Collective Intelligence and Civilizational Continuity
...
## 8. Operational Conditions for Civic Memory
...
## 9. Governance Conditions for Civic Memory
...
## 10. Civic Memory as Interface-Level Infrastructure
...
## 11. Relationship to Persistent Digital Object Systems
...
## 12. Relationship to Provenance and Authenticity Standards
...
The preceding section describes the governance conditions civic memory requires. This section names the surfaces through which those conditions become checkable and actionable by the people affected. A memory regime that cannot be inspected or challenged is indistinguishable from an editorial policy held privately.

### 13.1 Accountability surfaces
...
### 13.2 Participant agency surfaces
...
## 14. Community Signals Informing DP22
...
### 15.2 Transformation accountability
...
### 15.6 Continuity across boundaries
...
### 15.8 Resistance to epistemic attack
...
## 17. Minimum Viable Civic Memory Layer
...
## 19. Civic Memory and Civilizational Learning
...
## 24. Minimum DP22 Alignment (Non-Normative)
